...
namespace BadmintonCourtDAOs
{
	public class SlotDAO
	{
		...
		public List<BookedSlot> GetA_CourtSlotsInTimeInterval(DateTime start, DateTime end, string id) => _dbContext.BookedSlots.Where(x => !(x.EndTime <= start || x.StartTime >= end) && x.CourtId == id).ToList();
